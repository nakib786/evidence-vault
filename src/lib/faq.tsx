/**
 * Frequently asked questions — shared content.
 *
 * Lives here, not inside FaqModal, because two surfaces show the exact same answers: the
 * FAQ modal reached from the header nav, and the floating help bubble (LiveChatBubble).
 * Keeping one array means an answer never drifts out of sync between the two.
 */
